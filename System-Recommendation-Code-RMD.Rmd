...
# Build the linear model (mean + movie bias)
...
# Build the linear model (mean + movie bias + user bias)
...
# Construct the linear model (mean + movie bias + user bias)
...
# PRUEBA SEGUNDA FINAL_HOLDOUT_TEST
...
# Evaluate the model
valuation <- tibble(
  Models = "Linear model with regularized bias (validation)",
...
# The plot shows that most movie ratings are high, with 4 being the most frequent, followed by 3 and 5. 
# Lower ratings (1 and 2) are much less common, indicating that users generally rate movies positively.
